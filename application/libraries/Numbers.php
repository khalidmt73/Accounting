 ...
 * Example:
 * <code>
 *     echo  $this->numbers->money2str(13315.12, 'SAR', 'ar'); 
 *     
 *     $obj->setFeminine(1);
 *     $obj->setFormat(1);
 *     
...
class Numbers
{
    ...
    {
        $xml = simplexml_load_file(dirname(__FILE__).'/numbers/ArNumbers.xml');
        ...
        $xml = simplexml_load_file(dirname(__FILE__).'/numbers/arab_countries.xml');

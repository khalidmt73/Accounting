...
<div class='menu_up text-center'>
    <ul class="nav nav-tabs">
        <li role="presentation"  <?php if ($this->uri->segment(2) == 'add' ) echo 'class="active"'; ?>>
            <a href="<?php echo base_url('expense/add') ?>"><i class="fa fa-plus"></i>
                <?php echo $this->lang->line('add') . '&nbsp;' . $this->lang->line('expense') ?>
            </a>
        </li>
        <li role="presentation" <?php if ($this->uri->segment(2) == 'view' OR $this->uri->segment(2) == 'result') echo 'class="active"'; ?>>
            <a href="<?php echo base_url('expense/view') ?>"><i class="fa fa-eye"></i>

                <?php echo $this->lang->line('view') . '&nbsp;' . $this->lang->line('expenses') ?>
            </a>
        </li>
		<?php if($this->uri->segment(2) == 'edit'){ ?>
		<li role="presentation"  <?php if ($this->uri->segment(2) == 'edit' ) echo 'class="active"'; ?>>
            <a href="<?php echo base_url('expense/edit') ?>"><i class="fa fa-plus"></i>
                <?php echo $this->lang->line('edit') . '&nbsp;' . $this->lang->line('expense') ?>
            </a>
        </li>
		<?php } ?>
    </ul>

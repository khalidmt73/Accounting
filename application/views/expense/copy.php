            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" method="post" action="<?php echo base_url('expense/create/' . $value->id . '/' . $value->journal_id); ?>" >
                            <fieldset>
                                <?php Myform_grp(); ?>
                                ...
                                ?></div><?php
                                Myform_grp();
                                inp_text('thevalue', $value->thevalue, "", 'class ="form-control" style="width:263px;height:29px;margin:10px;" id="thevalue" ');
                                ?></div><?php
                                Myform_grp();
...
<script>
    $(document).ready(function () {
		...
		else if(x.val() == 4110) v = 'ضيافة';
		else if(x.val() == 4111) v = 'حفلات';
		else                     v = 'مكافأة إشراف';

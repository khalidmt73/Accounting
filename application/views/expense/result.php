...
<div id="result2" >
    ...
    base_url('expense/result/id/ASC/' . $fromdate . '/' . $todate . '/cl');
    ?>/' + this.value + '/'" >
    ...
    <?php echo $this->lang->line('download'); ?>
                                            ...
                                            <ul class="download_menu dropdown-menu" role="menu">
                                                <li>		
                                                    <a href="<?php echo
    base_url('expense/pdf/' . $order . '/' . $sc . '/' . $fromdate . '/' . $todate . '/');
    ?>"class='a_img'>
                                                ...
                                                <li>
                                                    <a href="<?php echo
                                                       base_url('expense/excel/' . $order . '/' . $sc . '/' . $fromdate . '/' . $todate . '/');
                                                       ?>" class='a_img'>
                                                ...
                                                <li>
                                                    <a href="<?php echo
                                                        base_url('expense/word/' . $order . '/' . $sc . '/' . $fromdate . '/' . $todate . '/');
                                                        ?>" class='a_img'>
                                                ...
                                                <li>
                                                    <a href="<?php echo
                                                    base_url('expense/printed/' . $order . '/' . $sc . '/' . $fromdate . '/' . $todate . '/');
                                                    ?>" class='a_img'>
                                ...
                                <thead>
                                    <tr >
                                        ...
                                        <th class="text-center">
                                               <?php if ($sc == 'ASC') { ?>
                                                <a href="<?php echo
                                           base_url('expense/result/thedate/DESC/' . $fromdate . '/' . $todate . '/cl/' . $limit . '/');
                                           ?>">
                                            ...
                                            <?php if ($sc == 'DESC') { ?>
                                                <a href="<?php echo
                                        base_url('expense/result/thedate/ASC/' . $fromdate . '/' . $todate . '/cl/' . $limit . '/');
                                                ?>">
                                                    <i class="fa fa-sort"></i>
                                                </a>
                                            <?php } ?>
                                        ...
                                        <th class="text-center">
                                            <?php if ($sc == 'ASC') { ?>
                                                <a href="<?php echo
                                                base_url('expense/result/beneficiary/DESC/' . $fromdate . '/' . $todate . '/cl/' . $limit . '/');
                                                ?>">
                                                    <i class="fa fa-sort"></i>
                                                </a>
                                            <?php } ?>
    <?php if ($sc == 'DESC') { ?>
                                                <a href="<?php echo
        base_url('expense/result/beneficiary/ASC/' . $fromdate . '/' . $todate . '/cl/' . $limit . '/');
        ?>">
                                                    <i class="fa fa-sort"></i>
                                                </a>
    <?php } ?>
    ...
    <?php if ($sc == 'ASC') { ?>
                                                <a href="<?php echo base_url('expense/result/thevalue/DESC/' . $fromdate . '/' . $todate . '/cl/' . $limit . '/'); ?>">
                                                    <i class="fa fa-sort"></i>
                                                </a>
                                            <?php } ?>
                                            <?php if ($sc == 'DESC') { ?>
                                                <a href="<?php echo base_url('expense/result/thevalue/ASC/' . $fromdate . '/' . $todate . '/cl/' . $limit . '/'); ?>">
                                                    <i class="fa fa-sort"></i>
                                                </a>
                                               <?php } ?>
    ...
    <?php if ($sc == 'ASC') { ?>
                                                <a href="<?php echo
        base_url('expense/result/id/DESC/' . $fromdate . '/' . $todate . '/cl/');
        ?>">
                                                    <i class="fa fa-sort"></i>
                                                </a>
    <?php } ?>
    ...
    for ($i = 0; $i < count($records); $i++) {
        ?>
                                        <tr>
                                            ...
                                            <td><?php echo $records[$i]->beneficiary; ?></td>
                                            <td>
        <?php
        ...
        ?>
                                            ...
                                            <td>
                                                <a  href="<?php echo base_url('expense/edit/' . $records[$i]->id) ?>" >

...
?>
<input class="form-control input-sm"  type="text" id="fromdate" name="fromdate" value="<?php echo $fromdate ?>" placeholder="2015-01-30" style="width:110px;height:30px;"   onchange="AjaxSearch(this.value, 'result', '', 'report/journal_view/' + fromdate.value + '/' + todate.value + '/')" onclick="restData('result2')">

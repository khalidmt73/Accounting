                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-striped table-hover" style="width:600px" align="center">
                            ...
                            <tr>
                                <td colspan="2" align="center" valign="top"><strong>قائمة الدخل<br>
                                        مجموع الإيرادات - مجموع المصروفات
                                    </strong></td>
                            </tr>
                            <?php
                            $TotalValue1 = 0;
...
?>
                            ...
                            <tr>
                                <td align="right" valign="top"><strong>صافي الدخل</strong></td>
                                <td align="left" valign="top">
                                    <strong><?php
                            $Net = $TotalValue1 - $TotalValue2;
                            echo $Net;
?>
                                    </strong></td>
                            </tr>

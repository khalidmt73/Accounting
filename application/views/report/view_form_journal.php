...
?>
<input class="form-control input-sm"  type="text" id="entry_f" name="entry_f" value="" placeholder="" style="width:50px;height:30px;"   onchange="AjaxSearch(this.value, 'result', '', 'report/journal_view/' + entry_f.value + '/' + entry_t.value + '/')" onclick="restData('result2')">

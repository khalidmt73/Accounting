				...
				<div class="col-lg-10 col-xs-12">
					<div class="row" >
							<div class="site_name text-center" >
								...
								<span class="logo_name_ar">
									&nbsp; > &nbsp;<?php echo $this->lang->line('mydata'); ?>
								</span>
							</div>
						</div>
					<div class="row">
<!-- ------------------------------------------------------------------------------------ -->
			<nav class="navbar_top " role="navigation" >
					<div class="container-fluid">
						...
						<?php }else{?>
										<li>
										<a href="<?php echo base_url($site[0].'/index'); ?>">
									<?php echo $this->lang->line($site[0]); ?>
								</a>
								</li>
									<?php } ?>
						<li <?php
							if ($this->uri->segment(1) == 'mail_box') {
								echo 'class="active"';
							}
							?> >
								<a href="<?php echo base_url('mail_box/index'); ?>">
									<?php echo $this->lang->line('mails'); ?>
								</a>
							</li>		
						<li <?php
							...
							?> >
								<a href="<?php echo base_url('mydata/password'); ?>">

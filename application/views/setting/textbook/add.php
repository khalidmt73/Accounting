		...
		<table class="viewData_tb table">
			<tr >
				<td class="text-right col-xs-4">
					<a href="<?php echo base_url('textbook/index'); ?>">
...
echo form_open(base_url('textbook/create'),$atrb);
echo '
<h4> <i class="fa fa-plus-square"></i>
      '.$this->lang->line("add").' '.$this->lang->line("textbook").'
</h4>';
...
$data = array(
			   ...
			   'required'    => 'required',
			   'placeholder' => $this->lang->line("textbook1")
             );
...
echo form_dropdown('id_course',$drop3,'0','class="form-control" id= "id_course"  style="width:50%;margin-bottom:10px;"');

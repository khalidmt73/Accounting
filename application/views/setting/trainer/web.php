<div class="navbar_links text-right" >
		<?php echo $this->lang->line('trainer')?>
</div>
...
foreach ($trainer as $key => $value) {?>
  <div class="new">
       <img  src="<?php echo  base_url('public/img/trainer/'.$value->pic);?>" width="150" height="150" class="imgView<?php echo $i; ?>" 
	     data-toggle="modal" data-target="#myModal<?php echo $i;?>"/>
      
	   
	   
          <div class="trainer_font">
			<?php  echo $value->head;?>
			<i class="trainer<?php echo $i; ?> fa fa-search-plus"></i>
		  </div>
     ...
     <script>
	     $(document).ready(function() {
           $('.trainer<?php echo $i?>').hover(function(){
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img  src="<?php echo  base_url('public/img/trainer/'.$value->pic);?>"  class="img-thumbnail img-responsive center-block" /> 
      </div>

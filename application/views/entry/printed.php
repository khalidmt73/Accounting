                    ...
                    <table align="center" lang="ar" dir="rtl" border="1" class="table"  
                        ...
                        <thead>
                            <tr align="center">
                                ...
                                <th width="180px" ><?php echo $this->lang->line('depositor') ?></th>
                        ...
                        <tbody>
                            <?php for ($i = 0; $i < count($records); $i++) { ?>
                                <tr align="center">
                                    ...
                                    <td width="200px" align='right'>&nbsp;<?php echo $records[$i]->byName; ?></td>
                                    <td width="120px"><?php echo $records[$i]->thevalue . '&nbsp;' . $this->lang->line('currency'); ?></td>
                                    <td width="180px" align='right'>&nbsp;<?php echo $records[$i]->depositor; ?></td>

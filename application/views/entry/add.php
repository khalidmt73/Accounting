        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" method="post" action="<?php echo base_url('entry/create'); ?>" >
                        <fieldset>
                            ...
                            <select class="form-control" name="box_accountno"  id="box_accountno"  
                                    ...
                                    <option value="<?php echo $valueBn->accountno ?>" 
                                            <?php if ($valueBn->accountno == '4103') echo "selected" ?> >
                            ...
                            <select class="form-control " name="accountno" id="accountno" 
                                    style="width:263px;height:29px;margin:10px;">
                                        <?php foreach ($entryRecords as $valueIn) { ?> 
                                    <option value="<?php echo $valueIn->accountno ?>" <?php if ($valueIn->accountno == '11201') echo "selected" ?> >
                                            <?php echo $valueIn->title ?>
                                    </option>
                                    <?php } ?>
                            </select>
                            <input type="text" name="thedate" id="thedate"  value="<?php echo '2019-03-20'//date('Y-m-d'); ?>" placeholder="<?php echo date('Y-m-d'); ?>" class ="form-control"	style="width:263px;height:29px;margin:10px;">
...
<?php if (isset($oneRecord)) { ?>
    ...
    <?php foreach ($oneRecord as $value_oneRecord) { ?>
                    <tr>
                        ...
                        <td><?php echo $value_oneRecord->id; ?></td>
                        <td>

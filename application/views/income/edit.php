            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" method="post" action="<?php echo base_url('income/update/' . $value->id . '/' . $value->journal_id); ?>" >
                            <fieldset>
                                <?php Myform_grp(); ?>
                                ...
                                <select class="form-control" name="box_accountno" style="width:263px;height:29px;margin:10px;" 
                                    ...
                                    ?></div><?php
                                Myform_grp();
                                inp_text('byName', $value->byName, "", 'class ="form-control" style="width:263px;height:29px;margin:10px;" id="byName"');
                                ?></div><?php
                                Myform_grp();
                                inp_text('thevalue', $value->thevalue, "", 'class ="form-control" style="width:263px;height:29px;margin:10px;" id="thevalue" readonly');
                                ?></div><?php
                                Myform_grp();
                                inp_text('depositor', $value->depositor, "", 'class ="form-control" style="width:263px;height:29px;margin:10px;" id="depositor"', false);
                                ?></div><?php
                                Myform_grp();

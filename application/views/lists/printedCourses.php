...
<head>
    ...
    <body>
		...
		<tr>
			<td height="100px;" valign="center" align="center"><br/><?php echo $no++; ?></td>
			<td><br/><?php echo $value->course; ?></td>
			<td><br/><?php echo $value->target; ?></td>
			<td><br/><?php echo $value->fromdate; ?></td>
			<td><br/><?php echo $value->name; ?></td>
		</tr>
		<?php } ?>
		</table>

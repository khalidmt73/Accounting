  ...
  <center>
      <div class="container text-center">
			<div class="row"><!-- /.row -->
				...
				<?php
					$js = 'id="id_textbook_linkin" onChange="get_present(this.value ,year.value,semester.value)"';
					$drop3['0'] =$this->lang->line("textbook");
							foreach($textbook_linkin as $val3){
				$drop3[$val3->id.'/'.$val3->division.'/'.$val3->id_trainer.'/'.$val3->id_textbook] = $val3->name.'-'.$val3->textbook.'-'.$val3->division;
							 }

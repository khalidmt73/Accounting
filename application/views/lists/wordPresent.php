        ...
        <div id="MainPage">
            <div id="MainMenu">
                <div class="container text-center">
                    ...
                    <h3 align="center" class="headline"><?php echo count($records) . ' ' . $this->lang->line('recordes'); ?></h3>
                    <table align="center" lang="ar" dir="rtl" border="1" class="table" width="800px" 
                           style='width:800px;border-collapse:collapse;border:1;font-size:16.0pt;font-family:"Arial","sans-serif"''>
                        <thead>
                            <tr align="center">
                                <th  width="50px" ><?php echo $this->lang->line('no') ?>     </th>
                                <th  width="100px" ><?php echo $this->lang->line('name') ?></th>
                                <th  width="200px" ><?php echo $this->lang->line('academicNo') ?></th>
                                <th width="150px" ><?php echo $this->lang->line('p') ?></th>
                        ...
                        <tbody>
                            <?php for ($i = 0; $i < count($records); $i++) { ?>
                                <tr align="center">
                                    ...
                                    <td width="200px"><?php echo $records[$i]->academicNo; ?></td>
                                    <td width="200px"><input type="checkbox" name=""></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
